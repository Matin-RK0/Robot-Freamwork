...
${WALK_URL}    https://zoodexwalk.ir
${BROWSER}    chrome
${TIMEOUT}    15s
${LOGO}    //*[@id="header-desktop"]/div/section/div/section[1]/a/img
${ZOODEX_MOBILE_LOGO}    //*[@id="__nuxt"]/div[2]/div[1]/header/div/div[3]/img
${CLOSE_MODAL_BUTTON_M}    //*[@id="__nuxt"]/div[2]/div[1]/div[2]/div[2]/div/div[1]/p[1]/img
${CLOSE_MODAL_BUTTON}      //*[@id="__nuxt"]/div[2]/div/div[4]/div/div[1]/p[1]/img
